...
const i32 max_material[] = {171, 571, 559, 1001, 1875, 0, 0};
const i32 material[] = {S(75, 171), S(229, 571), S(246, 559), S(337, 1001), S(769, 1875), 0};
const i32 pst_rank[][8] = {
    {0, S(-2, -1), S(-2, -1), S(0, -2), S(1, 0), S(3, 4), 0, 0},
    {S(-3, -6), S(-2, -3), S(-1, -1), S(1, 3), S(3, 4), S(7, 1), S(4, 0), S(-10, 1)},
    {S(-2, -2), S(0, -2), S(0, -1), S(1, 0), S(2, 1), S(4, 1), S(0, 1), S(-6, 2)},
    {S(-2, -4), S(-3, -5), S(-4, -3), S(-4, 1), S(0, 2), S(3, 2), S(3, 4), S(6, 2)},
    {S(1, -13), S(1, -11), S(0, -6), S(-1, 1), S(0, 5), S(1, 7), S(-3, 10), S(1, 8)},
    {S(-3, -5), S(-3, -1), S(-3, 0), S(-1, 3), S(1, 4), S(6, 4), S(2, 2), S(4, -7)},
};
const i32 pst_file[][8] = {
    {S(-1, 0), S(-2, 1), S(-1, 0), S(0, -1), S(1, 0), S(2, 0), S(2, 1), S(-1, -1)},
    {S(-3, -5), S(-2, -1), S(0, 2), S(2, 4), S(2, 3), S(2, 1), S(1, -1), S(0, -3)},
    {S(-2, 0), S(0, -1), 0, S(0, 1), S(0, 1), S(-1, 0), S(1, 0), S(0, -1)},
    {S(-2, 0), S(-2, 1), S(-1, 1), S(1, 0), S(1, 0), S(1, 0), S(2, -1), S(0, -1)},
    {S(-2, -6), S(-1, -3), S(0, -1), S(0, 1), S(-1, 2), S(0, 3), S(2, 2), S(2, 3)},
    {S(-1, -4), S(2, 0), S(-2, 2), S(-5, 4), S(-5, 3), S(-4, 3), S(2, 0), S(2, -5)},
};
const i32 open_files[][5] = {
    {S(3, 3), S(-3, 21), S(16, 18), S(3, 15), S(-21, 7)},
    {S(1, -16), S(-5, -3), S(42, 4), S(-2, 20), S(-45, -6)},
};
const i32 mobilities[] = {S(7, 4), S(6, 9), S(3, 5), S(3, 3), S(-2, -2)};
const i32 pawn_protection[] = {S(21, 15), S(-2, 24), S(5, 19), S(6, 9), S(-6, 24), S(-23, 26)};
const i32 passers[] = {S(-10, 23), S(14, 63), S(53, 132), S(216, 224)};
const i32 pawn_passed_protected = S(12, 20);
const i32 pawn_doubled = S(-10, -43);
const i32 pawn_phalanx = S(12, 18);
const i32 pawn_passed_blocked[] = {S(-7, -20), S(10, -50), S(6, -89), S(-10, -82)};
const i32 pawn_passed_king_distance[] = {S(2, -7), S(-3, 11)};
const i32 bishop_pair = S(17, 93);
const i32 king_shield[] = {S(29, -7), S(21, -6)};
