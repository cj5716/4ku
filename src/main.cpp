...
const i32 max_material[] = {151, 527, 529, 969, 1802, 0, 0};
const i32 material[] = {S(87, 151), S(348, 527), S(361, 529), S(476, 969), S(1045, 1802), 0};
const i32 pst_rank[] = {
    ...
    S(2, -11), S(3, -8),  S(2, -3),  S(0, 2),   S(-1, 5), S(-1, 5), S(-4, 7), S(-2, 4),   // Queen
    S(-1, -6), S(1, -2),  S(-1, 0),  S(-3, 3),  S(-1, 5), S(5, 4),  S(5, 2),  S(5, -6),   // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, 0),   // Pawn
    S(-4, -3), S(-1, -1), S(0, 1),  S(2, 3),  S(2, 3),  S(2, 0),  S(1, -1), S(-1, -4),  // Knight
    ...
    S(-2, -5), S(2, -2),  S(-1, 0), S(-4, 2), S(-4, 2), S(-1, 1), S(2, -1), S(0, -5),   // King
};
...
const i32 king_attacks[] = {S(12, -5), S(18, -4), S(26, -9), S(17, 13), 0};
const i32 pawn_protection[] = {S(23, 16), S(2, 18), S(6, 19), S(8, 10), S(-8, 23), S(-30, 26)};
const i32 pawn_threat_penalty[] = {S(-4, 0), S(21, 0), S(12, 6), S(11, 20), S(9, 17), S(4, 8)};
const i32 passers[] = {S(7, 15), S(45, 52), S(87, 125), S(277, 214)};
const i32 pawn_passed_protected = S(13, 23);
const i32 pawn_doubled_penalty = S(11, 39);
const i32 pawn_phalanx = S(12, 16);
const i32 pawn_passed_blocked_penalty[] = {S(4, 21), S(-7, 46), S(-10, 91), S(51, 91)};
const i32 pawn_passed_king_distance[] = {S(0, -7), S(-3, 12)};
const i32 bishop_pair = S(29, 85);
