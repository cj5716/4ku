...
const int max_material[] = {119, 398, 424, 738, 1461, 0, 0};
const int material[] = {S(115, 119), S(382, 398), S(400, 424), S(506, 738), S(909, 1461), 0};
const int pst_rank[][8] = {
    ...
    {S(-2, -2), S(-4, -3), S(-5, -2), S(-5, 0), S(-1, 2), S(3, 2), S(5, 3), S(8, 1)},
    {S(-3, -9), S(-1, -9), S(-1, -5), S(-2, 2), S(0, 6), S(4, 4), S(-2, 8), S(4, 4)},
    {S(1, -6), S(0, -2), S(-3, 0), S(-7, 3), S(-4, 4), S(2, 4), S(1, 3), S(2, -3)},
};
const int pst_file[][4] = {
    {S(-2, 0), S(1, 1), 0, S(1, -1)},
    {S(-4, -3), S(-1, -1), S(2, 1), S(3, 2)},
    {S(-2, -2), S(1, 0), S(0, 1), S(1, 1)},
    {S(-2, 0), S(-1, 0), S(1, 0), S(1, -1)},
    {S(-1, -3), 0, S(1, 2), S(1, 2)},
    {S(0, -3), S(2, 0), S(-2, 1), S(-5, 2)},
};
const int open_files[][3] = {
    {S(24, 19), S(8, 10), S(-45, 13)},
    {S(55, 11), S(-14, 36), S(-86, 0)},
};
const int pawn_protection[] = {S(30, 13), S(8, 11), S(4, 6), S(12, 2), S(-6, 13), S(-30, 22)};
const int passers[] = {S(3, 10), S(38, 37), S(77, 93), S(260, 158)};
const int pawn_passed_protected = S(14, 18);
const int pawn_doubled = S(-14, -30);
const int pawn_phalanx = S(12, 12);
const int pawn_passed_blocked[] = {S(-8, -18), S(8, -41), S(12, -74), S(-15, -84)};
const int pawn_passed_king_distance[] = {S(1, -5), S(-5, 10)};
const int bishop_pair = S(39, 61);
const int king_shield[] = {S(50, -11), S(39, -11)};
