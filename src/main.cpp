...
const i32 max_material[] = {141, 493, 497, 911, 1709, 0, 0};
const i32 material[] = {S(88, 141), S(348, 493), S(359, 497), S(478, 911), S(1026, 1709), 0};
const i32 pst_rank[] = {
    0,         S(-2, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 3),  0,        0,          // Pawn
    S(-2, -5), S(0, -3),  S(1, -1),  S(3, 3),   S(4, 4),  S(5, 1),  S(2, 0),  S(-14, 1),  // Knight
    S(0, -2),  S(2, -1),  S(2, 0),   S(2, 0),   S(3, 0),  S(2, 0),  S(-2, 1), S(-10, 2),  // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-2, 1),  S(0, 2),  S(2, 2),  S(0, 3),  S(2, 1),    // Rook
    S(2, -11), S(3, -8),  S(2, -3),  S(0, 2),   S(-1, 5), S(-1, 5), S(-5, 8), S(-2, 3),   // Queen
    S(0, -6),  S(1, -2),  S(-1, 0),  S(-4, 3),  S(0, 4),  S(4, 4),  S(7, 2),  S(6, -4),   // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, -1),  // Pawn
    S(-5, -3), S(-1, -1), S(0, 2),  S(2, 3),  S(2, 2),  S(2, 0),  S(1, -1), S(-1, -3),  // Knight
    S(-2, -1), 0,         S(1, 0),  S(0, 1),  S(1, 1),  S(0, 1),  S(1, 0),  S(-1, -1),  // Bishop
    S(-2, 0),  S(-1, 1),  S(0, 1),  S(1, 0),  S(2, -1), S(1, 0),  S(1, 0),  S(-1, -1),  // Rook
    S(-3, -3), S(-1, -1), S(-1, 1), S(0, 1),  S(0, 2),  S(1, 2),  S(3, -1), S(1, -1),   // Queen
...
const i32 king_attacks[] = {S(12, -6), S(19, -4), S(25, -9), S(17, 10), 0};
const i32 pawn_protection[] = {S(22, 16), S(1, 18), S(6, 18), S(8, 11), S(-8, 24), S(-27, 23)};
const i32 pawn_threat_penalty[] = {S(-4, -1), S(21, -2), S(12, 5), S(12, 20), S(11, 14), S(5, 8)};
const i32 passers[] = {S(23, 7), S(71, 36), S(128, 94), S(317, 182)};
const i32 pawn_passed_protected = S(11, 22);
const i32 pawn_doubled_penalty = S(11, 37);
const i32 pawn_phalanx = S(12, 16);
const i32 pawn_passed_blocked_penalty[] = {S(12, 15), S(-4, 41), S(-6, 78), S(62, 84)};
const i32 pawn_passed_king_distance[] = {S(-2, -5), S(-3, 11)};
const i32 bishop_pair = S(31, 78);
const i32 king_shield[] = {S(33, -9), S(24, -7)};
