...
const i32 max_material[] = {140, 464, 466, 868, 1772, 0, 0};
const i32 material[] = {S(91, 140), S(308, 464), S(315, 466), S(413, 868), S(668, 1772), 0};
const i32 pst_rank[] = {
    0,         S(-3, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 2), 0,        0,          // Pawn
    S(-3, -5), S(-1, -2), S(0, -1),  S(2, 3),   S(3, 4),  S(6, 1), S(4, 0),  S(-11, 1),  // Knight
    S(-1, -1), S(2, -1),  S(1, 0),   S(2, 0),   S(2, 1),  S(3, 0), 0,        S(-8, 2),   // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-3, 0),  S(0, 2),  S(2, 2), S(1, 3),  S(2, 1),    // Rook
    S(2, -11), S(2, -8),  S(1, -4),  S(0, 1),   S(-1, 5), S(0, 5), S(-3, 6), S(-1, 5),   // Queen
    S(-1, -5), S(1, -2),  0,         S(-3, 3),  S(0, 4),  S(4, 5), S(2, 3),  S(2, -4),   // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, 0),   // Pawn
    S(-5, -3), S(-2, -1), S(0, 1),  S(2, 3),  S(2, 2),  S(2, 0),  S(1, 0),  S(-1, -3),  // Knight
    S(-2, 0),  0,         S(1, 0),  S(0, 1),  S(1, 1),  S(0, 1),  S(2, 0),  S(-1, -1),  // Bishop
    S(-2, 0),  S(-1, 1),  S(0, 1),  S(1, 0),  S(2, -1), S(1, 0),  S(1, 0),  S(-2, -1),  // Rook
    S(-2, -4), S(-1, -2), S(-1, 0), S(0, 1),  S(0, 2),  S(1, 2),  S(2, 1),  S(1, 0),    // Queen
    S(-3, -5), S(2, -2),  S(-1, 1), S(-3, 2), S(-4, 2), S(-1, 1), S(2, -1), S(0, -5),   // King
};
...
const i32 king_attacks[] = {S(11, -5), S(20, -5), S(27, -9), S(21, 5), 0};
const i32 pawn_protection[] = {S(22, 15), S(2, 15), S(7, 17), S(8, 9), S(-6, 21), S(-30, 23)};
const i32 pawn_threat_penalty[] = {S(-4, 1), S(21, 2), S(11, 6), S(10, 18), S(10, 15), S(4, 6)};
const i32 passers[] = {S(3, 14), S(33, 51), S(63, 127), S(189, 267)};
const i32 pawn_passed_protected = S(9, 18);
const i32 pawn_doubled_penalty = S(10, 37);
const i32 pawn_phalanx = S(12, 13);
const i32 pawn_passed_blocked_penalty[] = {S(9, 12), S(-7, 40), S(-12, 86), S(-19, 174)};
const i32 pawn_passed_king_distance[] = {S(1, -7), S(-4, 11)};
const i32 bishop_pair = S(31, 73);
const i32 king_shield[] = {S(36, -11), S(28, -7)};
