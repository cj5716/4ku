...
const i32 max_material[] = {139, 436, 437, 820, 1682, 0, 0};
const i32 material[] = {S(86, 139), S(297, 436), S(302, 437), S(404, 820), S(642, 1682), 0};
const i32 pst_rank[] = {
    0,         S(-3, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 3), 0,        0,          // Pawn
    S(-3, -5), S(-2, -3), S(0, -1),  S(2, 2),   S(3, 4),  S(6, 1), S(4, 0),  S(-10, 1),  // Knight
    S(-1, -2), S(2, -1),  S(2, 0),   S(2, 0),   S(2, 0),  S(3, 0), 0,        S(-9, 2),   // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-3, 1),  S(0, 2),  S(3, 2), S(1, 3),  S(3, 1),    // Rook
    S(2, -11), S(2, -9),  S(1, -4),  S(-1, 1),  S(-1, 6), S(0, 5), S(-3, 7), S(0, 5),    // Queen
    S(-1, -5), S(1, -2),  0,         S(-2, 3),  S(1, 4),  S(5, 4), S(4, 3),  S(1, -2)    // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, -1),  // Pawn
    S(-5, -3), S(-2, -1), S(0, 1),  S(2, 3),  S(2, 2),  S(2, 0),  S(1, 0),  S(0, -3),   // Knight
    S(-2, 0),  0,         S(1, 0),  S(0, 1),  S(1, 1),  S(0, 1),  S(1, 0),  S(-1, 0),   // Bishop
    S(-2, 0),  S(-1, 1),  S(0, 1),  S(1, 0),  S(2, -1), S(1, 0),  S(2, 0),  S(-2, 0),   // Rook
    S(-2, -3), S(-1, -2), S(-1, 1), S(0, 1),  S(0, 2),  S(1, 2),  S(3, 0),  S(2, -1),   // Queen
    S(-3, -4), S(2, -2),  S(-2, 1), S(-2, 1), S(-3, 2), S(-1, 1), S(1, -1), S(0, -5)    // King
};
...
const i32 mobilities[] = {S(8, 5), S(7, 7), S(3, 4), S(4, 2), S(-4, -1)};
const i32 king_attacks[] = {S(11, -5), S(19, -4), S(26, -9), S(20, 5), 0};
const i32 pawn_protection[] = {S(21, 14), S(-1, 17), S(7, 17), S(7, 10), S(-7, 22), S(-28, 22)};
const i32 pawn_threat_penalty[] = {S(-4, 0), S(21, 1), S(12, 4), S(11, 18), S(10, 13), S(3, 7)};
const i32 passers[] = {S(12, 12), S(50, 43), S(94, 105), S(235, 233)};
const i32 pawn_passed_protected = S(8, 19);
const i32 pawn_doubled_penalty = S(10, 37);
const i32 pawn_phalanx = S(11, 13);
const i32 pawn_passed_blocked_penalty[] = {S(10, 11), S(-6, 38), S(-9, 76), S(-1, 144)};
const i32 pawn_passed_king_distance[] = {S(-1, -6), S(-3, 10)};
const i32 bishop_pair = S(28, 73);
const i32 king_shield[] = {S(34, -10), S(26, -6)};
