...
const i32 max_material[] = {206, 704, 744, 1296, 2473, 0, 0};
const i32 material[] = {S(108, 206), S(416, 704), S(445, 744), S(548, 1296), S(1206, 2473), 0};
const i32 pst_rank[][8] = {
    {0, S(-4, 0), S(-5, -1), S(-1, -2), S(2, 0), S(8, 3), 0, 0},
    {S(-5, -7), S(-1, -2), S(1, 1), S(3, 5), S(8, 6), S(12, 2), S(6, -2), S(-23, -3)},
    {S(-2, -6), S(2, -2), S(4, 0), S(4, 2), S(4, 3), S(5, 1), S(1, -1), S(-18, 2)},
    {S(1, -3), S(-2, -5), S(-3, -4), S(-4, 0), S(0, 1), S(4, 2), S(5, 4), S(-1, 5)},
    {S(-1, -16), S(2, -12), S(1, -5), S(-1, 4), S(0, 8), S(4, 5), S(-1, 8), S(-3, 9)},
    {S(2, -6), S(1, 1), S(-7, 4), S(-17, 9), S(-15, 11), S(-3, 10), S(-2, 7), S(3, -4)},
};
const i32 pst_file[][8] = {
    {S(-3, 1), S(-1, 1), S(-1, 0), S(1, -1), S(2, -1), S(2, 0), S(3, 1), S(-3, -1)},
    {S(-7, -5), S(-2, -1), S(1, 3), S(2, 5), S(3, 4), S(3, 1), S(1, -2), S(-2, -7)},
    {S(-3, -2), 0, S(1, 0), S(0, 3), S(0, 3), S(-1, 2), S(3, -1), S(0, -4)},
    {S(-2, 1), S(-3, 2), S(-2, 2), S(0, 1), S(2, -1), S(2, -1), S(4, -2), S(1, -2)},
    {S(-3, -6), S(-2, -2), S(-1, 2), S(0, 3), S(-1, 5), S(1, 4), S(3, -1), S(4, -4)},
    {S(1, -7), S(2, -2), S(-3, 1), S(-6, 3), S(-7, 3), S(-2, 2), S(3, 0), S(2, -5)},
};
const i32 open_files[][5] = {
    {S(1, 9), S(-10, 27), S(34, 34), S(9, 29), S(-35, 11)},
    {S(-4, -19), S(-20, -4), S(71, 22), S(-23, 71), S(-115, -2)},
};
const i32 pawn_protection[] = {S(34, 26), S(14, 25), S(9, 17), S(21, 11), S(-8, 19), S(-56, 46)};
const i32 passers[] = {S(-23, 20), S(-6, 83), S(-12, 211), S(143, 377)};
const i32 pawn_passed_protected = S(22, 32);
const i32 pawn_doubled = S(-16, -52);
const i32 pawn_phalanx = S(17, 19);
const i32 pawn_passed_blocked[] = {S(-30, -10), S(-8, -43), S(11, -117), S(-46, -143)};
const i32 pawn_passed_king_distance[] = {S(4, -11), S(-5, 17)};
const i32 bishop_pair = S(38, 109);
const i32 king_shield[] = {S(52, -16), S(40, -12)};
