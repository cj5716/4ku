...
const i32 max_material[] = {159, 531, 563, 963, 1894, 0, 0};
const i32 material[] = {S(84, 159), S(286, 531), S(303, 563), S(370, 963), S(676, 1894), 0};
const i32 pst_rank[][8] = {
    {0, S(-3, 0), S(-3, -1), S(-1, -1), S(2, 0), S(5, 3), 0, 0},
    {S(-5, -6), S(-4, -3), S(-1, 0), S(1, 4), S(4, 5), S(9, 2), S(6, -1), S(-9, -1)},
    {S(-4, -4), S(-1, -2), 0, S(1, 2), S(2, 3), S(5, 1), S(2, 0), S(-7, 1)},
    {S(-2, -3), S(-3, -4), S(-4, -3), S(-4, 0), S(0, 2), S(3, 2), S(4, 4), S(7, 2)},
    {S(-2, -12), S(0, -11), S(0, -5), S(-1, 2), S(-1, 6), S(2, 5), S(-1, 8), S(2, 7)},
    {S(0, -6), S(0, -2), S(-2, 0), S(-4, 3), S(-2, 5), S(3, 5), S(3, 2), S(1, -4)},
};
const i32 pst_file[][8] = {
    {S(-2, 0), S(-1, 1), S(-1, 0), S(0, -1), S(1, 0), S(2, 0), S(2, 0), S(-1, -1)},
    ...
    {S(-3, -6), S(-1, -3), S(-1, 0), S(-1, 2), S(0, 3), S(1, 4), S(2, 1), S(3, 0)},
    {S(-1, -4), S(2, -1), S(-3, 1), S(-5, 3), S(-5, 2), S(-3, 2), S(2, -1), S(2, -5)},
};
const i32 open_files[][5] = {
    {S(0, 4), S(-6, 18), S(23, 23), S(6, 16), S(-26, 8)},
    {S(-4, -14), S(-10, -2), S(49, 18), S(-3, 37), S(-62, -7)},
};
const i32 pawn_protection[] = {S(23, 15), S(2, 20), S(2, 6), S(8, 4), S(-8, 14), S(-33, 29)};
const i32 passers[] = {S(-7, 19), S(15, 57), S(50, 128), S(196, 218)};
const i32 pawn_passed_protected = S(12, 22);
const i32 pawn_doubled = S(-10, -43);
const i32 pawn_phalanx = S(11, 14);
const i32 pawn_passed_blocked[] = {S(-7, -19), S(9, -46), S(12, -87), S(4, -82)};
const i32 pawn_passed_king_distance[] = {S(2, -7), S(-3, 11)};
const i32 bishop_pair = S(24, 81);
const i32 king_shield[] = {S(36, -6), S(27, -7)};
const i32 pawn_attacked[] = {S(-61, -50), S(-88, -100)};
