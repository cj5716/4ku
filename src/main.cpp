...
const i32 max_material[] = {142, 473, 475, 882, 1809, 0, 0};
const i32 material[] = {S(93, 142), S(315, 473), S(326, 475), S(429, 882), S(691, 1809), 0};
const i32 pst_rank[] = {
    0,         S(-3, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 2), 0,        0,          // Pawn
    S(-2, -5), S(-1, -2), S(1, -1),  S(2, 3),   S(3, 3),  S(6, 1), S(3, 0),  S(-12, 1),  // Knight
    S(-1, -1), S(2, -1),  S(2, 0),   S(2, 0),   S(2, 0),  S(3, 0), 0,        S(-8, 1),   // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-2, 0),  S(0, 2),  S(3, 2), S(1, 3),  S(1, 1),    // Rook
    S(3, -10), S(3, -8),  S(2, -4),  S(0, 1),   S(-1, 5), S(0, 5), S(-3, 5), S(-4, 5),   // Queen
    S(-1, -5), S(1, -2),  0,         S(-2, 2),  S(1, 4),  S(6, 4), S(4, 3),  S(3, -4),   // King
};
const i32 pst_file[] = {
...
const i32 king_attacks[] = {S(11, -5), S(20, -5), S(26, -9), S(19, 9), 0};
const i32 pawn_protection[] = {S(22, 15), S(2, 15), S(7, 18), S(8, 9), S(-6, 21), S(-30, 24)};
const i32 pawn_threat_penalty[] = {S(-4, 0), S(21, 1), S(11, 6), S(11, 18), S(10, 16), S(3, 7)};
const i32 passers[] = {S(6, 12), S(38, 49), S(75, 123), S(209, 265)};
const i32 pawn_passed_protected = S(10, 19);
const i32 pawn_doubled_penalty = S(11, 37);
const i32 pawn_phalanx = S(12, 13);
const i32 pawn_passed_blocked_penalty[] = {S(9, 14), S(-6, 42), S(-9, 88), S(-13, 175)};
