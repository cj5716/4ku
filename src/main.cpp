...
const i32 max_material[] = {147, 520, 522, 956, 1782, 0, 0};
const i32 material[] = {S(89, 147), S(349, 520), S(362, 522), S(479, 956), S(1046, 1782), 0};
const i32 pst_rank[] = {
    ...
    S(-1, -5), S(1, -1),  S(-1, 0),  S(-4, 3),  S(-1, 5), S(5, 5),  S(5, 2),  S(5, -5),   // King
};
const i32 pst_file[] = {
    ...
    S(-2, -5), S(2, -1),  S(-1, 1), S(-4, 2), S(-4, 2), S(-1, 2), S(2, 0),  S(0, -5),   // King
};
...
const i32 pawn_protection[] = {S(23, 16), S(2, 18), S(6, 19), S(8, 10), S(-8, 23), S(-29, 25)};
const i32 pawn_threat_penalty[] = {S(-4, 0), S(21, 0), S(12, 7), S(10, 20), S(9, 17), S(4, 8)};
const i32 passers[] = {S(11, 12), S(51, 47), S(97, 115), S(284, 196)};
