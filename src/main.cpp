...
const i32 max_material[] = {159, 528, 560, 959, 1885, 0, 0};
const i32 material[] = {S(86, 159), S(296, 528), S(312, 560), S(382, 959), S(698, 1885), 0};
const i32 pst_rank[][8] = {
    {0, S(-3, 0), S(-3, -1), S(-1, -1), S(2, 0), S(5, 3), 0, 0},
    {S(-6, -6), S(-4, -3), S(-1, 0), S(1, 4), S(4, 5), S(9, 2), S(6, -1), S(-10, -1)},
    {S(-4, -4), S(-1, -2), 0, S(2, 2), S(3, 3), S(6, 1), S(2, 0), S(-8, 1)},
    {S(-2, -3), S(-4, -4), S(-4, -3), S(-4, 0), S(0, 2), S(3, 2), S(4, 4), S(7, 2)},
    {S(-2, -12), S(0, -11), S(0, -5), S(-1, 2), S(0, 6), S(2, 5), S(-1, 8), S(2, 7)},
...
const i32 pst_file[][8] = {
    ...
    {S(-3, -2), 0, S(0, 1), S(0, 2), S(0, 2), S(0, 1), S(2, 0), S(0, -3)},
    {S(-1, 0), S(-2, 1), S(-1, 1), 0, S(1, 0), S(1, 0), S(3, -1), S(0, -1)},
    {S(-3, -6), S(-1, -3), S(-1, 0), S(-1, 2), S(-1, 3), S(1, 4), S(3, 1), S(3, 0)},
    {S(-1, -4), S(2, -1), S(-3, 1), S(-5, 3), S(-5, 2), S(-3, 2), S(2, 0), S(2, -4)},
};
const i32 open_files[][5] = {
    {S(-1, 4), S(-6, 18), S(23, 23), S(6, 17), S(-26, 8)},
    {S(-4, -14), S(-10, -2), S(49, 18), S(-4, 37), S(-63, -7)},
};
const i32 pawn_protection[] = {S(24, 15), S(2, 20), S(2, 6), S(8, 4), S(-8, 13), S(-32, 29)};
const i32 passers[] = {S(-6, 19), S(17, 57), S(52, 128), S(200, 219)};
const i32 pawn_passed_protected = S(12, 22);
const i32 pawn_doubled = S(-10, -42);
const i32 pawn_phalanx = S(12, 14);
const i32 pawn_passed_blocked[] = {S(-6, -20), S(10, -47), S(12, -87), S(6, -83)};
