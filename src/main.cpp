...
const i32 max_material[] = {138, 491, 491, 897, 1667, 0, 0};
const i32 material[] = {S(83, 138), S(306, 491), S(318, 491), S(427, 897), S(941, 1667), 0};
const i32 pst_rank[] = {
    0,         S(-2, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(4, 2),  0,        0,          // Pawn
    S(-1, -5), S(0, -3),  S(1, -1),  S(3, 2),   S(4, 3),  S(5, 1),  S(2, 0),  S(-14, 2),  // Knight
    S(-1, -2), S(2, -1),  S(2, 0),   S(2, 0),   S(2, 0),  S(2, 0),  S(-1, 1), S(-9, 2),   // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-2, 1),  S(0, 2),  S(2, 2),  S(1, 3),  S(2, 1),    // Rook
    S(2, -11), S(3, -7),  S(2, -3),  S(0, 2),   S(-1, 5), S(-1, 5), S(-4, 6), S(-2, 4),   // Queen
    S(-3, -5), S(-2, -2), S(-3, 0),  S(-4, 3),  S(0, 4),  S(5, 3),  S(6, 1),  S(7, -6),   // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-1, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0), S(-1, 0),   // Pawn
    ...
    S(-2, -4), S(3, -1),  S(-1, 1), S(-4, 2), S(-3, 2), S(-1, 2), S(2, 0), S(0, -4),   // King
};
...
const i32 mobilities[] = {S(8, 5), S(7, 6), S(3, 4), S(3, 2), S(-4, -1)};
const i32 king_attacks[] = {S(10, -5), S(16, -3), S(22, -7), S(15, 12), 0};
const i32 pawn_protection[] = {S(22, 15), S(2, 17), S(5, 17), S(6, 9), S(-7, 21), S(-25, 23)};
const i32 pawn_threat_penalty[] = {S(-4, 0), S(20, 1), S(12, 6), S(9, 20), S(8, 17), S(4, 8)};
const i32 passers[] = {S(13, 10), S(55, 37), S(110, 92), S(285, 167)};
const i32 pawn_passed_protected = S(14, 19);
const i32 pawn_doubled_penalty = S(11, 35);
const i32 pawn_phalanx = S(12, 15);
const i32 pawn_passed_blocked_penalty[] = {S(5, 18), S(-9, 41), S(-9, 77), S(40, 75)};
const i32 pawn_passed_king_distance[] = {S(-1, -5), S(-2, 11)};
const i32 bishop_pair = S(29, 78);
const i32 king_shield[] = {S(32, -9), S(23, -7)};
