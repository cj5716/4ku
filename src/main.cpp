...
const i32 max_material[] = {139, 432, 435, 821, 1652, 0, 0};
const i32 material[] = {S(94, 139), S(334, 432), S(343, 435), S(456, 821), S(793, 1652), 0};
const i32 pst_rank[] = {
    ...
    S(2, -11), S(3, -9),  S(1, -4),  S(-1, 2),  S(-1, 5), S(0, 5), S(-3, 7), S(-1, 5),   // Queen
    S(-1, -5), S(1, -2),  0,         S(-2, 2),  S(1, 4),  S(6, 4), S(3, 3),  S(1, -3)    // King
};
const i32 pst_file[] = {
    ...
    S(-2, -5), S(2, -2),  S(-1, 1), S(-2, 1), S(-3, 2), S(-1, 1), S(2, -1), S(-1, -5)   // King
};
...
const i32 king_attacks[] = {S(11, -5), S(19, -5), S(27, -9), S(21, 4), 0};
const i32 pawn_protection[] = {S(22, 14), S(2, 14), S(6, 17), S(7, 10), S(-5, 19), S(-32, 25)};
const i32 pawn_threat_penalty[] = {S(-4, 1), S(21, 1), S(12, 5), S(11, 17), S(9, 17), S(6, 5)};
const i32 passers[] = {S(1, 14), S(30, 50), S(59, 123), S(192, 249)};
const i32 pawn_passed_protected = S(10, 18);
const i32 pawn_doubled_penalty = S(10, 37);
const i32 pawn_phalanx = S(12, 12);
const i32 pawn_passed_blocked_penalty[] = {S(9, 12), S(-6, 40), S(-8, 81), S(-10, 157)};
