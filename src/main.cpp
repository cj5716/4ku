...
const i32 pst_rank[] = {
    ...
    S(-1, -5), S(0, -2),  S(2, -1),  S(4, 2),   S(4, 3),  S(5, 1),  S(2, 0),  S(-16, 1),  // Knight
    S(0, -2),  S(2, -1),  S(2, 0),   S(2, 0),   S(3, 0),  S(2, 0),  S(-1, 1), S(-10, 2),  // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-3, 1),  S(0, 1),  S(2, 1),  S(1, 3),  S(3, 1),    // Rook
    S(3, -11), S(3, -7),  S(2, -3),  S(0, 2),   S(-1, 5), S(-1, 5), S(-4, 6), S(-1, 3),   // Queen
    S(-4, -4), S(-2, -1), S(-3, 0),  S(-4, 2),  S(0, 3),  S(7, 2),  S(8, 0),  S(6, -5),   // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0), S(-1, 0),   // Pawn
    S(-5, -3), S(-1, -1), S(0, 1),  S(2, 3),  S(2, 2),  S(2, 0),  S(1, 0), S(-1, -3),  // Knight
    S(-2, -1), 0,         S(1, 0),  S(0, 1),  S(1, 1),  0,        S(2, 0), S(-1, -1),  // Bishop
    S(-2, 0),  S(-1, 1),  S(0, 1),  S(1, 0),  S(2, -1), S(1, 0),  S(1, 0), S(-2, 0),   // Rook
    S(-2, -3), S(-1, -1), 0,        S(0, 1),  S(0, 2),  S(1, 1),  S(2, 0), S(1, 0),    // Queen
    S(-2, -4), S(3, -1),  S(-1, 1), S(-4, 2), S(-3, 2), S(-1, 1), S(2, 0), S(0, -4),   // King
};
...
const i32 mobilities[] = {S(8, 3), S(8, 6), S(3, 4), S(3, 2), S(-4, -1)};
const i32 king_attacks[] = {S(12, -4), S(18, -3), S(26, -7), S(19, 10), 0};
const i32 pawn_protection[] = {S(23, 14), S(1, 18), S(6, 16), S(7, 10), S(-8, 21), S(-32, 22)};
const i32 pawn_threat_penalty[] = {S(-3, 0), S(23, 0), S(13, 4), S(11, 17), S(9, 16), S(7, 5)};
const i32 passers[] = {S(5, 10), S(41, 38), S(93, 89), S(278, 157)};
const i32 pawn_passed_protected = S(14, 18);
const i32 pawn_doubled_penalty = S(13, 31);
const i32 pawn_phalanx = S(13, 15);
const i32 pawn_passed_blocked_penalty[] = {S(8, 15), S(-5, 36), S(-2, 69), S(43, 75)};
const i32 pawn_passed_king_distance[] = {S(0, -5), S(-2, 9)};
const i32 bishop_pair = S(32, 70);
const i32 king_shield[] = {S(34, -10), S(24, -7)};
