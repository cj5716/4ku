...
const i32 max_material[] = {147, 519, 523, 956, 1782, 0, 0};
const i32 material[] = {S(89, 147), S(349, 519), S(362, 523), S(480, 956), S(1046, 1782), 0};
const i32 pst_rank[] = {
...
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(1, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, 0),   // Pawn
    S(-5, -3), S(-1, -1), S(0, 1),  S(2, 3),  S(2, 3),  S(2, 0),  S(1, -1), S(-1, -3),  // Knight
    ...
    S(-2, -5), S(2, -2),  S(-1, 1), S(-4, 2), S(-4, 2), S(-1, 2), S(2, -1), S(0, -5),   // King
};
...
const i32 king_attacks[] = {S(11, -5), S(18, -4), S(27, -9), S(17, 12), 0};
const i32 pawn_protection[] = {S(23, 17), S(2, 18), S(6, 19), S(8, 10), S(-8, 23), S(-29, 25)};
const i32 pawn_threat_penalty[] = {S(-4, 0), S(21, 0), S(11, 7), S(10, 20), S(9, 17), S(4, 8)};
...
[[nodiscard]] i32 eval(Position &pos) {
    ...
    return ((score + 0x8000 >> 16) * phase +
            int16_t(score) * (128 - stronger_side_pawns_missing * stronger_side_pawns_missing) / 128 * (24 - phase)) /
           24;
}
