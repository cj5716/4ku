...
const i32 max_material[] = {145, 512, 512, 936, 1739, 0, 0};
const i32 material[] = {S(85, 145), S(331, 512), S(343, 512), S(455, 936), S(1004, 1739), 0};
const i32 pst_rank[] = {
