...
const i32 max_material[] = {145, 510, 512, 935, 1737, 0, 0};
const i32 material[] = {S(86, 145), S(331, 510), S(344, 512), S(456, 935), S(1004, 1737), 0};
const i32 pst_rank[] = {
    0,         S(-3, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 3),  0,        0,          // Pawn
    S(-1, -6), S(0, -3),  S(1, -1),  S(3, 3),   S(4, 4),  S(5, 1),  S(2, 0),  S(-15, 2),  // Knight
    ...
    S(-3, -5), S(-2, -2), S(-3, 0),  S(-5, 3),  S(-3, 5), S(2, 5),  S(3, 2),  S(5, -5),   // King
};
const i32 pst_file[] = {
    ...
    S(-3, -4), S(3, -1),  S(-1, 1), S(-4, 2), S(-3, 2), S(-1, 2), S(2, 0), S(0, -5),   // King
};
...
const i32 king_attacks[] = {S(11, -5), S(18, -4), S(25, -8), S(17, 12), 0};
const i32 pawn_protection[] = {S(23, 16), S(2, 17), S(5, 18), S(7, 10), S(-7, 21), S(-29, 25)};
const i32 pawn_threat_penalty[] = {S(-4, 0), S(21, 1), S(12, 6), S(10, 20), S(9, 17), S(5, 8)};
const i32 passers[] = {S(10, 12), S(48, 46), S(97, 114), S(280, 195)};
const i32 pawn_passed_protected = S(13, 21);
const i32 pawn_doubled_penalty = S(11, 38);
const i32 pawn_phalanx = S(12, 16);
const i32 pawn_passed_blocked_penalty[] = {S(5, 19), S(-9, 45), S(-9, 87), S(45, 89)};
const i32 pawn_passed_king_distance[] = {S(-1, -6), S(-3, 12)};
const i32 bishop_pair = S(29, 81);
