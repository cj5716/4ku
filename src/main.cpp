...
const i32 max_material[] = {146, 515, 518, 951, 1780, 0, 0};
const i32 material[] = {S(91, 146), S(363, 515), S(375, 518), S(496, 951), S(1073, 1780), 0};
const i32 pst_rank[] = {
    0,         S(-2, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 3),  0,        0,          // Pawn
    S(-2, -5), S(0, -3),  S(2, -1),  S(3, 3),   S(4, 4),  S(5, 1),  S(2, 0),  S(-15, 1),  // Knight
    S(0, -2),  S(2, -1),  S(2, 0),   S(2, 0),   S(3, 0),  S(2, 0),  S(-2, 0), S(-11, 2),  // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-2, 1),  S(0, 2),  S(2, 2),  S(0, 3),  S(2, 1),    // Rook
    S(3, -11), S(3, -8),  S(2, -3),  S(0, 2),   S(-1, 5), S(-1, 5), S(-4, 7), S(-2, 4),   // Queen
    S(-1, -6), S(1, -2),  S(-1, 0),  S(-5, 3),  S(-1, 5), S(5, 4),  S(6, 2),  S(5, -5),   // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, 0),   // Pawn
    S(-5, -3), S(-1, -1), S(0, 2),  S(2, 3),  S(2, 3),  S(2, 0),  S(1, -1), S(-1, -3),  // Knight
    ...
    S(-2, -5), S(2, -2),  S(-1, 1), S(-4, 2), S(-4, 2), S(-1, 1), S(2, -1), S(0, -5),   // King
};
...
const i32 king_attacks[] = {S(12, -6), S(19, -4), S(26, -9), S(18, 11), 0};
const i32 pawn_protection[] = {S(23, 16), S(2, 17), S(7, 18), S(9, 10), S(-8, 25), S(-28, 25)};
const i32 pawn_threat_penalty[] = {S(-4, -1), S(22, -1), S(12, 6), S(12, 21), S(9, 17), S(5, 8)};
const i32 passers[] = {S(21, 7), S(67, 41), S(118, 109), S(305, 201)};
const i32 pawn_passed_protected = S(10, 24);
const i32 pawn_doubled_penalty = S(11, 38);
const i32 pawn_phalanx = S(12, 16);
const i32 pawn_passed_blocked_penalty[] = {S(8, 17), S(-4, 42), S(-8, 86), S(56, 95)};
const i32 pawn_passed_king_distance[] = {S(-1, -6), S(-3, 12)};
const i32 bishop_pair = S(30, 82);
