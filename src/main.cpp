...
const i32 max_material[] = {141, 451, 453, 851, 1680, 0, 0};
const i32 material[] = {S(94, 141), S(350, 451), S(359, 453), S(475, 851), S(873, 1680), 0};
const i32 pst_rank[] = {
    0,         S(-3, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 2), 0,        0,          // Pawn
    S(-3, -5), S(-1, -3), S(1, -1),  S(2, 2),   S(3, 4),  S(6, 1), S(4, 0),  S(-12, 1),  // Knight
    S(-1, -2), S(2, -1),  S(2, 0),   S(2, 0),   S(2, 1),  S(3, 0), 0,        S(-9, 2),   // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-3, 1),  S(0, 1),  S(2, 2), S(1, 3),  S(3, 1),    // Rook
    S(2, -12), S(3, -9),  S(1, -4),  S(-1, 1),  S(-1, 5), S(0, 5), S(-3, 7), S(-1, 6),   // Queen
    S(-1, -5), S(1, -2),  0,         S(-2, 2),  S(1, 4),  S(7, 3), S(5, 2),  S(5, -4)    // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, -1),  // Pawn
    S(-5, -3), S(-1, -1), S(0, 1),  S(2, 3),  S(2, 2),  S(2, 1),  S(1, 0),  S(-1, -3),  // Knight
    ...
    S(-3, -5), S(2, -2),  S(-2, 1), S(-3, 2), S(-4, 2), S(-1, 1), S(2, -1), S(0, -5)    // King
};
...
const i32 king_attacks[] = {S(12, -6), S(19, -4), S(27, -10), S(21, 3), 0};
const i32 pawn_protection[] = {S(22, 14), S(0, 15), S(7, 16), S(8, 9), S(-6, 22), S(-31, 25)};
const i32 pawn_threat_penalty[] = {S(-4, 1), S(22, 0), S(13, 3), S(11, 18), S(9, 15), S(5, 6)};
const i32 passers[] = {S(7, 13), S(44, 48), S(80, 121), S(227, 208)};
const i32 pawn_passed_protected = S(10, 21);
const i32 pawn_doubled_penalty = S(11, 37);
const i32 pawn_phalanx = S(12, 11);
const i32 pawn_passed_blocked_penalty[] = {S(10, 14), S(-4, 41), S(-12, 84), S(4, 97)};
const i32 pawn_passed_king_distance[] = {S(0, -6), S(-3, 11)};
const i32 bishop_pair = S(31, 73);
const i32 king_shield[] = {S(36, -11), S(27, -7)};
