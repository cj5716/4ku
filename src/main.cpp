...
const i32 max_material[] = {153, 538, 539, 988, 1840, 0, 0};
const i32 material[] = {S(91, 153), S(358, 538), S(371, 539), S(488, 988), S(1072, 1840), 0};
const i32 pst_rank[] = {
    0,         S(-3, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 3),  0,        0,          // Pawn
    S(-2, -5), S(0, -3),  S(2, -1),  S(3, 3),   S(4, 4),  S(6, 1),  S(2, 0),  S(-15, 1),  // Knight
    S(0, -2),  S(2, -1),  S(2, 0),   S(2, 0),   S(2, 0),  S(2, 0),  S(-1, 0), S(-10, 2),  // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-2, 1),  S(0, 2),  S(2, 2),  S(1, 3),  S(2, 1),    // Rook
    S(3, -12), S(3, -8),  S(2, -4),  S(0, 2),   S(0, 5),  S(-1, 5), S(-4, 7), S(-2, 4),   // Queen
    S(-1, -6), S(0, -2),  S(-1, 0),  S(-4, 3),  S(-1, 5), S(5, 4),  S(6, 2),  S(5, -6),   // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, -1),  // Pawn
    S(-5, -3), S(-1, -1), S(0, 2),  S(2, 3),  S(2, 3),  S(2, 1),  S(1, -1), S(-1, -4),  // Knight
    S(-2, -1), S(0, -1),  0,        S(0, 1),  S(1, 1),  S(0, 1),  S(2, 0),  S(-1, -1),  // Bishop
    S(-2, 0),  S(-1, 1),  S(0, 1),  S(1, 0),  S(2, -1), S(1, 0),  S(1, 0),  S(-1, -1),  // Rook
    S(-2, -3), S(-1, -1), S(-1, 0), S(0, 1),  S(0, 2),  S(1, 2),  S(2, 0),  S(1, 0),    // Queen
    S(-2, -5), S(3, -1),  S(-1, 1), S(-4, 2), S(-4, 3), S(-2, 2), S(2, 0),  S(0, -5),   // King
};
...
const i32 king_attacks[] = {S(12, -5), S(19, -4), S(28, -9), S(18, 13), 0};
const i32 pawn_protection[] = {S(23, 17), S(2, 19), S(6, 19), S(8, 11), S(-8, 24), S(-30, 26)};
const i32 pawn_threat_penalty[] = {S(-3, 0), S(22, 0), S(12, 6), S(11, 20), S(9, 17), S(5, 8)};
const i32 passers[] = {S(9, 13), S(46, 51), S(92, 124), S(274, 218)};
const i32 pawn_passed_protected = S(11, 23);
const i32 pawn_doubled_penalty = S(11, 39);
const i32 pawn_phalanx = S(12, 17);
const i32 pawn_passed_blocked_penalty[] = {S(5, 20), S(-5, 45), S(-6, 90), S(41, 99)};
const i32 pawn_passed_king_distance[] = {S(0, -7), S(-3, 12)};
const i32 bishop_pair = S(29, 87);
