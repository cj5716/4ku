...
const i32 max_material[] = {158, 507, 506, 924, 1850, 0, 0};
const i32 material[] = {S(86, 158), S(274, 507), S(285, 506), S(382, 924), S(670, 1850), 0};
const i32 pst_rank[][8] = {
    ...
    {S(0, -5), S(0, -1), S(-1, 1), S(-2, 4), S(0, 5), S(5, 5), S(4, 3), S(3, -4)},
};
const i32 pst_file[][8] = {
    ...
    {S(-2, -5), S(-2, -3), S(-1, -1), S(-1, 1), S(0, 2), S(0, 3), S(2, 2), S(3, 1)},
    {S(-2, -5), S(2, -1), S(-2, 2), S(-5, 3), S(-4, 3), S(-3, 2), S(2, -1), S(1, -5)},
};
const i32 open_files[][5] = {
    {S(2, 5), S(-4, 20), S(19, 16), S(4, 15), S(-23, 9)},
    {S(-2, -14), S(-8, -2), S(44, 3), S(-7, 25), S(-58, -2)},
};
const i32 mobilities[] = {S(7, 5), S(7, 8), S(3, 5), S(4, 4), S(-3, -1)};
const i32 pawn_protection[] = {S(22, 15), S(0, 20), S(7, 19), S(8, 9), S(-6, 24), S(-35, 27)};
const i32 passers[] = {S(-2, 20), S(25, 59), S(61, 134), S(198, 216)};
const i32 pawn_passed_protected = S(10, 22);
const i32 pawn_doubled = S(-11, -42);
const i32 pawn_phalanx = S(12, 14);
const i32 pawn_passed_blocked[] = {S(-8, -19), S(7, -47), S(9, -90), S(-5, -93)};
const i32 pawn_passed_king_distance[] = {S(1, -7), S(-3, 11)};
const i32 bishop_pair = S(23, 82);
const i32 king_shield[] = {S(32, -9), S(25, -6)};
