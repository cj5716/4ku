...
const i32 max_material[] = {148, 455, 492, 892, 1697, 0, 0};
const i32 material[] = {S(75, 148), S(294, 455), S(308, 492), S(351, 892), S(793, 1697), 0};
const i32 pst_rank[][8] = {
    {0, S(-3, 0), S(-4, -1), S(-1, -1), S(2, 0), S(6, 2), 0, 0},
    {S(-3, -7), S(0, -3), S(1, 0), S(3, 3), S(6, 4), S(8, 2), S(3, 0), S(-18, -1)},
    {S(0, -4), S(4, -1), S(5, 0), S(5, 1), S(3, 2), S(2, 1), S(-1, 0), S(-18, 1)},
    {S(4, -4), S(1, -5), S(0, -4), S(-2, -1), S(1, 1), S(2, 3), S(4, 4), S(-10, 7)},
    {S(1, -16), S(2, -11), S(2, -5), S(-1, 2), S(-1, 7), S(1, 6), S(-2, 9), S(-2, 9)},
    {S(1, -7), S(0, -1), S(-3, 1), S(-8, 4), S(-4, 5), S(2, 5), S(4, 4), S(8, -4)},
};
const i32 pst_file[][8] = {
    {S(-1, 0), S(0, 1), 0, S(1, -1), S(1, 0), S(1, 0), S(2, 0), S(-3, 0)},
    {S(-5, -4), S(-1, -1), S(1, 2), S(2, 4), S(2, 3), S(3, 1), S(1, -1), S(-2, -5)},
    {S(-2, -2), 0, S(1, 0), S(0, 2), S(0, 2), S(-1, 2), S(3, -1), S(0, -3)},
    {S(-2, 1), S(-3, 2), S(-2, 2), S(0, 1), S(1, -1), S(2, -1), S(2, -1), S(1, -2)},
    {S(-3, -4), S(-1, -2), S(-1, 1), S(0, 2), S(0, 4), S(0, 3), S(2, 0), S(3, -4)},
    {S(-2, -4), S(1, -1), S(-2, 1), S(-4, 2), S(-5, 3), S(-1, 2), S(3, 0), S(0, -3)},
};
const i32 open_files[][5] = {
    {S(-1, 11), S(-8, 21), S(33, 29), S(8, 26), S(-24, 10)},
    {S(-5, -10), S(-22, 0), S(66, 5), S(-22, 59), S(-81, -3)},
};
const i32 pawn_protection[] = {S(29, 19), S(17, 18), S(10, 17), S(22, 8), S(-8, 22), S(-51, 39)};
const i32 passers[] = {S(-3, 14), S(18, 49), S(34, 130), S(148, 248)};
const i32 pawn_passed_protected = S(22, 18);
const i32 pawn_doubled = S(-14, -39);
const i32 pawn_phalanx = S(14, 12);
const i32 pawn_passed_blocked[] = {S(-14, -16), S(5, -40), S(13, -83), S(-9, -152)};
const i32 pawn_passed_king_distance[] = {S(1, -7), S(-4, 13)};
const i32 bishop_pair = S(42, 55);
const i32 king_shield[] = {S(52, -14), S(39, -14)};
