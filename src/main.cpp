...
const i32 max_material[] = {143, 474, 476, 883, 1810, 0, 0};
const i32 material[] = {S(93, 143), S(312, 474), S(322, 476), S(422, 883), S(683, 1810), 0};
const i32 pst_rank[] = {
    0,         S(-3, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(5, 2), 0,        0,          // Pawn
    S(-2, -5), S(-1, -2), S(0, -1),  S(2, 3),   S(3, 3),  S(6, 1), S(3, 0),  S(-12, 1),  // Knight
    S(-1, -1), S(2, -1),  S(2, 0),   S(2, 0),   S(2, 0),  S(3, 0), 0,        S(-8, 2),   // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-2, 0),  S(0, 2),  S(2, 2), S(1, 3),  S(1, 1),    // Rook
    S(3, -10), S(3, -8),  S(2, -4),  S(0, 1),   S(-1, 5), S(0, 5), S(-3, 6), S(-4, 5),   // Queen
    S(-1, -5), S(1, -2),  0,         S(-2, 3),  S(0, 4),  S(5, 4), S(4, 3),  S(3, -4),   // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, 0),   // Pawn
    S(-5, -2), S(-2, -1), S(0, 1),  S(2, 3),  S(2, 2),  S(2, 0),  S(1, -1), S(-1, -3),  // Knight
    ...
    S(-2, -4), S(3, -1),  S(-1, 2), S(-3, 3), S(-3, 3), S(-1, 2), S(2, 0),  S(0, -4),   // King
};
const i32 open_files[] = {
    ...
    S(-14, 37),
    S(-59, 1)};
const i32 mobilities[] = {S(9, 5), S(8, 7), S(3, 5), S(4, 2), S(-5, -1)};
const i32 king_attacks[] = {S(10, -5), S(19, -4), S(26, -9), S(18, 9), 0};
const i32 pawn_protection[] = {S(22, 15), S(2, 15), S(6, 18), S(8, 9), S(-6, 21), S(-30, 24)};
const i32 pawn_threat_penalty[] = {S(-4, 0), S(21, 2), S(11, 6), S(10, 18), S(9, 16), S(3, 7)};
const i32 passers[] = {S(5, 13), S(37, 49), S(73, 124), S(207, 281)};
const i32 pawn_passed_protected = S(10, 19);
const i32 pawn_doubled_penalty = S(10, 37);
const i32 pawn_phalanx = S(12, 13);
const i32 pawn_passed_blocked_penalty[] = {S(8, 15), S(-7, 43), S(-9, 88), S(-14, 176)};
const i32 pawn_passed_king_distance[] = {S(1, -6), S(-4, 12)};
const i32 bishop_pair = S(30, 76);
const i32 king_shield[] = {S(35, -11), S(27, -7)};
