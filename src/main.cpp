...
const i32 max_material[] = {140, 447, 450, 840, 1657, 0, 0};
const i32 material[] = {S(104, 140), S(354, 447), S(368, 450), S(490, 840), S(916, 1657), 0};
const i32 pst_rank[][8] = {
    {0, S(-2, 0), S(-3, -1), S(-1, -1), S(1, 0), S(5, 2), 0, 0},
    {S(-4, -5), S(-2, -3), S(-1, -1), S(2, 3), S(3, 4), S(8, 1), S(5, 0), S(-12, 1)},
    {S(-2, -2), S(1, -2), S(1, 0), S(1, 0), S(1, 1), S(4, 0), S(1, 0), S(-8, 2)},
    {S(-1, -4), S(-2, -4), S(-3, -2), S(-4, 1), S(-1, 2), S(3, 2), S(3, 3), S(6, 1)},
    {S(1, -13), S(1, -10), S(0, -5), S(-2, 1), S(-1, 6), S(1, 5), S(-2, 9), S(1, 7)},
    {S(0, -6), S(0, -2), S(-2, 0), S(-4, 3), S(-1, 4), S(6, 4), S(4, 2), S(5, -4)},
};
const i32 pst_file[][8] = {
    ...
    {S(-2, -5), S(2, -2), S(-1, 1), S(-3, 2), S(-4, 2), S(-1, 1), S(2, -1), S(1, -5)},
};
const i32 open_files[][5] = {
    {S(2, 5), S(-4, 21), S(20, 16), S(3, 20), S(-23, 10)},
    {S(-3, -12), S(-11, -1), S(48, -1), S(-14, 37), S(-65, 2)},
};
const i32 mobilities[] = {S(9, 5), S(8, 7), S(4, 4), S(4, 4), S(-5, -1)};
const i32 pawn_protection[] = {S(24, 15), S(2, 15), S(9, 17), S(9, 9), S(-5, 23), S(-35, 27)};
const i32 passers[] = {S(0, 15), S(30, 53), S(62, 129), S(207, 214)};
const i32 pawn_passed_protected = S(14, 19);
const i32 pawn_doubled_penalty = S(15, 38);
const i32 pawn_phalanx = S(14, 12);
const i32 pawn_passed_blocked_penalty[] = {S(12, 13), S(-4, 43), S(-7, 87), S(1, 104)};
const i32 pawn_passed_king_distance[] = {S(1, -7), S(-4, 11)};
const i32 bishop_pair = S(33, 72);
const i32 king_shield[] = {S(36, -12), S(29, -8)};
