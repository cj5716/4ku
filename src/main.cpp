...
const i32 max_material[] = {149, 524, 525, 960, 1782, 0, 0};
const i32 material[] = {S(88, 149), S(342, 524), S(356, 525), S(469, 960), S(1041, 1782), 0};
const i32 pst_rank[] = {
...
const i32 passers[] = {S(10, 13), S(47, 49), S(100, 116), S(280, 203)};
const i32 pawn_passed_protected = S(12, 21);
const i32 pawn_doubled_penalty = S(11, 38);
const i32 pawn_phalanx = S(12, 16);
const i32 pawn_passed_blocked_penalty[] = {S(6, 20), S(-7, 45), S(-7, 87), S(38, 94)};
