...
const i32 max_material[] = {163, 570, 570, 1043, 1968, 0, 0};
const i32 material[] = {S(84, 163), S(346, 570), S(358, 570), S(472, 1043), S(1011, 1968), 0};
const i32 pst_rank[] = {
    0,         S(-3, -1), S(-3, -1), S(-1, -1), S(1, 0),  S(5, 3), 0,        0,          // Pawn
    S(-2, -6), S(0, -3),  S(2, -1),  S(3, 3),   S(4, 4),  S(6, 2), S(3, 0),  S(-16, 1),  // Knight
    S(0, -2),  S(2, -1),  S(2, 0),   S(2, 0),   S(3, 0),  S(2, 0), S(-1, 0), S(-10, 2),  // Bishop
    S(0, -3),  S(-1, -4), S(-2, -2), S(-3, 1),  S(1, 1),  S(3, 1), S(0, 3),  S(2, 2),    // Rook
    S(2, -11), S(3, -9),  S(2, -3),  S(0, 2),   S(0, 5),  S(0, 5), S(-4, 7), S(-3, 4),   // Queen
    S(0, -6),  S(1, -2),  S(-1, 0),  S(-4, 3),  S(-2, 5), S(6, 4), S(5, 1),  S(3, -6),   // King
};
const i32 pst_file[] = {
    S(-1, 1),  S(-2, 1),  S(-1, 0), S(0, -1), S(1, 0),  S(2, 0),  S(2, 0),  S(-1, -1),  // Pawn
    S(-5, -3), S(-1, -1), S(0, 2),  S(2, 3),  S(2, 3),  S(2, 1),  S(1, 0),  S(0, -4),   // Knight
    S(-2, -1), 0,         0,        S(0, 1),  S(1, 1),  S(0, 1),  S(1, 0),  S(0, -1),   // Bishop
    S(-2, 0),  S(-1, 1),  S(0, 1),  S(1, 0),  S(2, -1), S(1, 0),  S(2, 0),  S(-2, 0),   // Rook
    S(-2, -3), S(-1, -1), S(-1, 1), S(0, 2),  S(0, 3),  S(1, 1),  S(2, -1), S(2, -1),   // Queen
    S(0, -6),  S(2, -2),  S(-2, 1), S(-4, 2), S(-4, 2), S(-2, 2), S(2, -1), S(1, -6),   // King
};
...
const i32 mobilities[] = {S(8, 6), S(7, 8), S(3, 5), S(3, 3), S(-4, -1)};
const i32 king_attacks[] = {S(13, -5), S(20, -3), S(29, -9), S(19, 17), 0};
const i32 pawn_protection[] = {S(22, 18), S(-1, 21), S(7, 20), S(8, 11), S(-6, 23), S(-26, 27)};
const i32 pawn_threat_penalty[] = {S(-4, -2), S(23, -1), S(11, 7), S(10, 22), S(8, 15), S(0, 12)};
const i32 passers[] = {S(8, 16), S(47, 56), S(85, 136), S(274, 238)};
const i32 pawn_passed_protected = S(9, 28);
const i32 pawn_doubled_penalty = S(9, 41);
const i32 pawn_phalanx = S(13, 17);
const i32 pawn_passed_blocked_penalty[] = {S(14, 19), S(-2, 46), S(-10, 95), S(74, 76)};
const i32 pawn_passed_king_distance[] = {S(0, -7), S(-3, 12)};
const i32 bishop_pair = S(25, 95);
const i32 king_shield[] = {S(31, -8), S(23, -6)};
