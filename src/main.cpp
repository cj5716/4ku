...
const i32 max_material[] = {149, 522, 524, 953, 1779, 0, 0};
const i32 material[] = {S(84, 149), S(326, 522), S(339, 524), S(451, 953), S(987, 1779), 0};
const i32 pst_rank[] = {
    0,         S(-2, 0),  S(-3, -1), S(-1, -1), S(1, 0),  S(4, 3),  0,        0,          // Pawn
    S(-1, -6), S(0, -3),  S(2, -1),  S(3, 3),   S(4, 4),  S(5, 2),  S(2, 0),  S(-15, 2),  // Knight
    S(0, -2),  S(2, -1),  S(2, 0),   S(2, 0),   S(3, 0),  S(2, 0),  S(-1, 1), S(-10, 2),  // Bishop
    S(0, -3),  S(-1, -3), S(-2, -2), S(-2, 1),  S(1, 2),  S(2, 2),  S(1, 3),  S(2, 1),    // Rook
    S(2, -11), S(3, -8),  S(2, -3),  S(0, 2),   S(-1, 5), S(-1, 5), S(-4, 7), S(-1, 3),   // Queen
...
const i32 pst_file[] = {
    ...
    S(-2, -5), S(3, -1),  S(-1, 1), S(-4, 3), S(-4, 3), S(-2, 2), S(2, 0), S(1, -5),   // King
};
...
const i32 king_attacks[] = {S(12, -5), S(17, -3), S(26, -8), S(18, 13), 0};
const i32 pawn_protection[] = {S(22, 16), S(1, 19), S(5, 18), S(6, 10), S(-7, 22), S(-28, 25)};
const i32 pawn_threat_penalty[] = {S(-4, 0), S(21, 1), S(12, 6), S(10, 20), S(8, 18), S(3, 9)};
const i32 passers[] = {S(13, 12), S(53, 46), S(105, 111), S(286, 196)};
const i32 pawn_passed_protected = S(11, 22);
const i32 pawn_doubled_penalty = S(10, 39);
const i32 pawn_phalanx = S(12, 16);
const i32 pawn_passed_blocked_penalty[] = {S(8, 18), S(-8, 44), S(-9, 86), S(46, 84)};
const i32 pawn_passed_king_distance[] = {S(-1, -6), S(-3, 11)};
const i32 bishop_pair = S(28, 82);
const i32 king_shield[] = {S(33, -9), S(23, -7)};
