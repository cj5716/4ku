...
const i32 max_material[] = {208, 722, 760, 1315, 2537, 0, 0};
const i32 material[] = {S(98, 208), S(363, 722), S(390, 760), S(474, 1315), S(1026, 2537), 0};
const i32 pst_rank[][8] = {
    {0, S(-4, 0), S(-4, -1), S(-1, -1), S(2, 0), S(8, 3), 0, 0},
    {S(-6, -7), S(-2, -2), S(1, 1), S(3, 5), S(8, 5), S(11, 2), S(5, -1), S(-21, -3)},
    {S(-2, -6), S(2, -2), S(4, 0), S(4, 2), S(5, 3), S(5, 1), S(1, 0), S(-20, 2)},
    {S(1, -3), S(-2, -5), S(-3, -4), S(-3, 0), S(0, 1), S(4, 2), S(5, 4), S(-2, 5)},
    {S(-1, -16), S(2, -13), S(1, -5), S(-1, 3), S(0, 8), S(4, 6), S(-1, 8), S(-4, 9)},
    {S(2, -6), S(1, 1), S(-7, 5), S(-18, 10), S(-17, 12), S(-7, 12), S(-5, 9), S(0, -3)},
};
const i32 pst_file[][8] = {
    {S(-3, 1), S(-1, 2), S(-1, 0), S(1, -1), S(2, -1), S(2, 0), S(2, 1), S(-3, -1)},
    {S(-7, -5), S(-2, -1), S(0, 3), S(2, 5), S(3, 4), S(3, 1), S(2, -2), S(-1, -7)},
    {S(-3, -2), 0, S(1, 0), S(0, 2), S(0, 2), S(0, 2), S(3, -1), S(0, -4)},
    {S(-2, 1), S(-3, 2), S(-2, 2), S(0, 1), S(2, -1), S(1, -1), S(4, -2), S(1, -2)},
    {S(-3, -7), S(-2, -2), S(-1, 2), S(0, 3), S(-1, 5), S(1, 4), S(3, -1), S(4, -4)},
    {S(1, -6), S(2, -2), S(-3, 2), S(-6, 3), S(-7, 3), S(-3, 2), S(3, 0), S(2, -5)},
};
const i32 open_files[][5] = {
    {S(2, 8), S(-11, 28), S(33, 33), S(10, 25), S(-35, 11)},
    {S(-5, -17), S(-20, -3), S(68, 24), S(-22, 67), S(-115, -1)},
};
const i32 pawn_protection[] = {S(33, 26), S(13, 25), S(10, 18), S(21, 11), S(-8, 19), S(-53, 43)};
const i32 passers[] = {S(-23, 21), S(-8, 84), S(-12, 207), S(161, 370)};
const i32 pawn_passed_protected = S(20, 34);
const i32 pawn_doubled = S(-14, -53);
const i32 pawn_phalanx = S(16, 19);
const i32 pawn_passed_blocked[] = {S(-29, -10), S(-5, -45), S(13, -117), S(-72, -126)};
const i32 pawn_passed_king_distance[] = {S(4, -10), S(-4, 16)};
const i32 bishop_pair = S(33, 110);
const i32 king_shield[] = {S(49, -14), S(37, -10)};
